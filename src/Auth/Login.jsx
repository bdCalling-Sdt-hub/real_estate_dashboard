...
import { setClientId, setToken } from "../page/redux/features/auth/authSlice";
const Login = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      if (payload?.success) {
        ...
        dispatch(setClientId(getClientId(payload)));
  ...
  const getClientId = (payload) => {
    if (payload.data.user.role === "AGENT") {
      return payload.data.user.clientId;
    } else if (payload.data.user.role === "CLIENT") {
      return payload.data.user._id;
    }
  };
  return (
