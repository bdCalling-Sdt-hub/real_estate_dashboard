        ...
        <div className="pl-4">
          <div className="mb-6 relative">
            ...
            <div className="absolute flex gap-3 bottom-6 right-[5px]">
              <button className="border px-3 rounded">Request for revision </button>
            <button className=" flex gap-3 bg-[#2A216D] text-white px-4 py-2 rounded-md hover:bg-purple-600">
              Send
